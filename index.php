...
<html lang="en-US">
  <head>
    ...
    <link href="<?php echo get_template_directory_uri()?>/./css/font-awesome/css/all.min.css?ver=1.2.0" rel="stylesheet">
    <link href="<?php echo get_template_directory_uri()?>/./css/bootstrap-icons/bootstrap-icons.css?ver=1.2.0" rel="stylesheet">
    <link href="<?php echo get_template_directory_uri()?>/./css/bootstrap.min.css?ver=1.2.0" rel="stylesheet">
    <link href="<?php echo get_template_directory_uri()?>/./css/aos.css?ver=1.2.0" rel="stylesheet">
    <link href="<?php echo get_template_directory_uri()?>/./css/main.css?ver=1.2.0" rel="stylesheet">
    <noscript>
      <style type="text/css">
        [data-aos] {
            opacity: 1 !important;
...
<header>
  <div class="cover bg-light">
    <div class="container px-3">
      <div class="row">
        <div class="col-lg-6 p-2"><img class="img-fluid" src="<?php echo get_template_directory_uri()?>/images/illustrations/hello3.svg" alt="hello"/></div>
        
        <div class="col-lg-6">
          <div class="mt-5">
            <p class="lead text-uppercase mb-1">Hello!</p>
            <h1 class="intro-title marker" data-aos="fade-left" data-aos-delay="50">I’m Faruk Ahmed Titu</h1>
            <p class="lead fw-normal mt-3" data-aos="fade-up" data-aos-delay="100">Wordpress Theme Developer</p>
            <div class="social-nav" data-aos="fade-up" data-aos-delay="200">
              <nav role="navigation">
                <ul class="nav justify-content-left">
                  <li class="nav-item"><a class="nav-link" href="https://twitter.com/Titufrk" title="Twitter"><i class="fab fa-twitter"></i><span class="menu-title sr-only">Twitter</span></a></li>
                  <li class="nav-item"><a class="nav-link" href="https://web.facebook.com/farukahmed.titu.5" title="Facebook"><i class="fab fa-facebook"></i><span class="menu-title sr-only">Facebook</span></a></li>
                  <li class="nav-item"><a class="nav-link" href="https://www.instagram.com/titufrk/" title="Instagram"><i class="fab fa-instagram"></i><span class="menu-title sr-only">Instagram</span></a></li>
                  <li class="nav-item"><a class="nav-link" href="https://www.linkedin.com/in/titu-frk-79755415a" title="LinkedIn"><i class="fab fa-linkedin"></i><span class="menu-title sr-only">LinkedIn</span></a></li>
                  <li class="nav-item"><a class="nav-link" href="https://www.behance.net/titufaruk" title="Behance"><i class="fab fa-behance"></i><span class="menu-title sr-only">Behance</span></a></li>
                </ul>
              </nav>
            </div>
...
<div class="section pt-4 px-3 px-lg-4" id="about">
  <div class="container-narrow">
    <div class="row">
      <div class="col-md-6">
        <h2 class="h4 my-2">Hello! I’m Faruk Ahmed Titu.</h2>
        <p>I am passionate about Wordpress Theme Developer. I am a skilled front-end developer and back-end developer. I am a quick learner and a team worker that gets the job done.</p>
        <div class="row mt-3">
          <div class="col-sm-2">
            <div class="pb-1">Age:</div>
          </div>
          <div class="col-sm-10">
            <div class="pb-1 fw-bolder">26</div>
          </div>
          <div class="col-sm-2">
            <div class="pb-1">Email:</div>
          </div>
          <div class="col-sm-10">
            <div class="pb-1 fw-bolder">titufrk@gmail.com</div>
          </div>
          <!-- <div class="col-sm-2">
          ...
          <div class="col-sm-10">
            <div class="pb-1 fw-bolder">01753210774</div>
          </div>
          <div class="col-sm-2">
            <div class="pb-1">Address:</div>
          </div>
          <div class="col-sm-10">
            <div class="pb-1 fw-bolder">Feni, Chittagong</div>
          </div>
          <div class="col-sm-2">
      ...
      <div class="col-md-5 offset-md-1" data-aos="fade-left" data-aos-delay="100"><img class="avatar img-fluid mt-2" src="<?php echo get_template_directory_uri()?>/images/new/15194607_385059585174079_7149073354864415498_o.jpg" width="400" height="400" alt="Walter Patterson"/></div>
    </div>
  </div>
</div>
<div class="section px-3 px-lg-4 pt-5" id="services">
  <div class="container-narrow">
    ...
    <div class="row py-3">
      <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="100"><img class="mb-2" src="<?php echo get_template_directory_uri()?>/images/services/web-design.svg" width="96" height="96" alt="web design"/>
        <div class="h5">Web Design</div>
      </div>
      <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="200"><img class="mb-2" src="<?php echo get_template_directory_uri()?>/images/services/graphic-design.svg" width="96" height="96" alt="graphic design"/>
        <div class="h5">Web Development</div>
      </div>
      <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="300"><img class="mb-2" src="<?php echo get_template_directory_uri()?>/images/services/ui-ux.svg" width="96" height="96" alt="ui-ux"/>
        <div class="h5">Onepage SEO</div>
      </div>
      <div class="col-md-3 text-center" data-aos="fade-up" data-aos-delay="400"><img class="mb-2" src="<?php echo get_template_directory_uri()?>/images/services/app-development.svg" width="96" height="96" alt="app development"/>
        <div class="h5">Speed Optimization</div>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="bg-light p-3">
      <div class="row">
        <div class="col-md-5">
          ...
          <div class="py-1">
            <div class="d-flex text-small fw-bolder"><span class="me-auto">Jquery</span><span>85%</span></div>
            <div class="progress my-1">
...
<div class="section px-2 px-lg-4 pt-5" id="portfolio">
  <div class="container">
    ...
    <div class="grid bp-gallery pb-3" data-aos="zoom-in-up" data-aos-delay="100">
      ...
      <div class="grid-item"><a href="https://project-1.developertitu.com/">
          <figure class="portfolio-item"><img src="<?php echo get_template_directory_uri()?>/images/new/Screenshot_1.png" data-bp="<?php echo get_template_directory_uri()?>/images/new/Screenshot_1.png"/>
            <figcaption>
              <h4 class="h5 mb-0">Web Design</h4>
              <div>developertitu.com</div>
            </figcaption>
          </figure></a></div>
      <div class="grid-item"><a href="https://project2.developertitu.com">
          <figure class="portfolio-item"><img src="<?php echo get_template_directory_uri()?>/images/new/Screenshot_2.png" data-bp="<?php echo get_template_directory_uri()?>/images/new/Screenshot_2.png" data-caption="Example of an optional caption."/>
            <figcaption> 
              <h4 class="h5 mb-0">Web Development</h4>
              <div>developertitu.com</div>
            </figcaption>
          </figure></a></div>
      <div class="grid-item"><a href="https://project3.developertitu.com">
          <figure class="portfolio-item"><img src="<?php echo get_template_directory_uri()?>/images/new/Screenshot_3.png" data-bp="<?php echo get_template_directory_uri()?>/images/new/Screenshot_3.png" data-caption="Example of an optional caption."/>
            <figcaption> 
              <h4 class="h5 mb-0">Wordpress</h4>
              <div>developertitu.com</div>
            </figcaption>
          </figure></a></div>
      <div class="grid-item"><a href="https://project-4.developertitu.com">
          <figure class="portfolio-item"><img src="<?php echo get_template_directory_uri()?>/images/new/Screenshot_4.png" data-bp="<?php echo get_template_directory_uri()?>/images/new/Screenshot_4.png"/>
            <figcaption>
              <h4 class="h5 mb-0">Wordpress</h4>
              <div>developertitu.com</div>
            </figcaption>
          </figure></a></div>
      <div class="grid-item"><a href="https://project-5.developertitu.com">
          <figure class="portfolio-item"><img src="<?php echo get_template_directory_uri()?>/images/new/Screenshot_5.png" data-bp="<?php echo get_template_directory_uri()?>/images/new/Screenshot_5.png"/>
            <figcaption>
              <h4 class="h5 mb-0">Web Development</h4>
              <div>developertitu.com</div>
            </figcaption>
          </figure></a></div>
      <div class="grid-item"><a href="https://project6.developertitu.com">
          <figure class="portfolio-item"><img src="<?php echo get_template_directory_uri()?>/images/new/Screenshot_6.png" data-bp="<?php echo get_template_directory_uri()?>/images/new/Screenshot_6.png"/>
            <figcaption>
              <h4 class="h5 mb-0">Web Development</h4>
              <div>developertitu.com</div>
            </figcaption>
          </figure></a></div>
      <div class="grid-item"><a href="https://project7.developertitu.com">
          <figure class="portfolio-item"><img src="<?php echo get_template_directory_uri()?>/images/new/Screenshot_7.png" data-bp="<?php echo get_template_directory_uri()?>/images/new/Screenshot_7.png"/>
            <figcaption>
              <h4 class="h5 mb-0">Wordpress</h4>
              <div>developertitu.com</div>
            </figcaption>
          </figure></a></div>
      <div class="grid-item"><a href="https://project8.developertitu.com">
          <figure class="portfolio-item"><img src="<?php echo get_template_directory_uri()?>/images/new/Screenshot_8.png" data-bp="<?php echo get_template_directory_uri()?>/images/new/Screenshot_8.png"/>
            <figcaption>
              <h4 class="h5 mb-0">Web Development</h4>
              <div>developertitu.com</div>
            </figcaption>
...
<footer class="pt-4 pb-4 text-center bg-light">
  <div class="container">
    <div class="my-3">
      <div class="h4">Faruk Ahmed Titu</div>
      <p>Web Developer</p>
    ...
    <script src="<?php echo get_template_directory_uri()?>/./scripts/imagesloaded.pkgd.min.js?ver=1.2.0"></script>
    <script src="<?php echo get_template_directory_uri()?>/./scripts/masonry.pkgd.min.js?ver=1.2.0"></script>
    <script src="<?php echo get_template_directory_uri()?>/./scripts/BigPicture.min.js?ver=1.2.0"></script>
    <script src="<?php echo get_template_directory_uri()?>/./scripts/purecounter.min.js?ver=1.2.0"></script>
    <script src="<?php echo get_template_directory_uri()?>/./scripts/bootstrap.bundle.min.js?ver=1.2.0"></script>
    <script src="<?php echo get_template_directory_uri()?>/./scripts/aos.min.js?ver=1.2.0"></script>
    <script src="<?php echo get_template_directory_uri()?>/./scripts/main.js?ver=1.2.0"></script>
    <?php wp_footer()?>
  </body>
</html>